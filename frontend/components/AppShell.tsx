...
type NavKey = "home" | "work" | "scenarios" | "skills" | "roster" | "settings";
...
const NAV: { key: NavKey; label: string; href: (id: string) => string; icon: JSX.Element }[] = [
  ...
  { key: "skills", label: "技能库", href: (id) => `/orgs/${id}/skills`, icon: <IconSkills /> },
...
function IconSkills() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M5 4h10a3 3 0 013 3v13H8a3 3 0 01-3-3z" />
